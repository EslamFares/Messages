            ...
            return Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child:
                      Text(conversations[position].first.message.last.dataTime,
                      style: TextStyle(
                        color:Colors.white,
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 5,),
                              Text(conversations[position][index].message.last.body,
                                style: TextStyle(
                                    color: _lightText,
                          ...
                          Transform.translate(
                              offset: Offset(-10, -11),
                              child: Text(
                                conversations[position][index].message.last.dataTime,
                                style: TextStyle(
                                    color: Colors.pink,
                                    fontSize: 11,
